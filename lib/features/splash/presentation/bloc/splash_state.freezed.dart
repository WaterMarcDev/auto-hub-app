...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  authenticated,TResult Function( bool isFirstTime)?  unauthenticated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return unauthenticated(_that.isFirstTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  authenticated,required TResult Function( bool isFirstTime)  unauthenticated,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  authenticated,TResult? Function( bool isFirstTime)?  unauthenticated,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Authenticated() when authenticated != null:
return authenticated();case _Unauthenticated() when unauthenticated != null:
...
class _Unauthenticated implements SplashState {
  const _Unauthenticated({required this.isFirstTime});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Unauthenticated&&(identical(other.isFirstTime, isFirstTime) || other.isFirstTime == isFirstTime));
}
...
@override
String toString() {
  return 'SplashState.unauthenticated(isFirstTime: $isFirstTime)';
}
...
/// @nodoc
abstract mixin class _$UnauthenticatedCopyWith<$Res> implements $SplashStateCopyWith<$Res> {
